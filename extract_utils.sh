...
function setup_vendor() {
    ...
    export PRODUCTMK="$CM_ROOT"/"$OUTDIR"/loire-vendor.mk
...
# This file is generated by device/$VENDOR/loire/setup-makefiles.sh

PRODUCT_PLATFORM := loire

EOF

printf "\$(call inherit-product, vendor/sony/aosp_nxp/nxp-vendor.mk)\n" >> $1
